...
<form action="" method="POST"  enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="number" min="1"  name="productcat" class="form-control" aria-describedby="helpId" required>
  </div>

   <div class="form-group">
    <label for="ProductBrand">Product Brand</label>
    <input type="number" min="1"  name="ProductBrand" class="form-control"  aria-describedby="helpId" required>
  </div>
